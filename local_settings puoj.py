...
ALLOWED_HOSTS = ['127.0.0.1', '10.6.29.8', 'puoj.phenikaa-uni.edu.vn', '118.70.240.183']

# Optional apps that DMOJ can make use of.
INSTALLED_APPS += (
)

MOSS_API_KEY = 505936737
...
EMAIL_HOST_USER = 'no.reply.puoj@gmail.com'
EMAIL_HOST_PASSWORD = 'syxtqrxuhzajkvtz'
EMAIL_PORT = 587
...
ADMINS = (
    ('dungpt', 'dung.phamtrung@phenikaa-uni.edu.vn'),
)

# The sender for the aforementioned emails.
SERVER_EMAIL = 'no.reply.puoj@gmail.com'
...
SITE_NAME = 'PUOJ'
SITE_FULL_URL = 'https://puoj.phenikaa-uni.edu.vn'
SITE_LONG_NAME = 'PUOJ: Phenikaa University Online Judge'
SITE_ADMIN_EMAIL = 'dung.phamtrung@phenikaa-uni.edu.vn'
...
EVENT_DAEMON_POST = 'ws://puoj.phenikaa-uni.edu.vn:15101/'
...
EVENT_DAEMON_GET = 'ws://puoj.phenikaa-uni.edu.vn/event/'
EVENT_DAEMON_GET_SSL = 'wss://puoj.phenikaa-uni.edu.vn/event/'  # Optional
